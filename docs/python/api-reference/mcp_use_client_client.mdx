...
**Returns**
><ResponseField name="returns" type="list[dict[str, Any]]" >Level of detail to return: - &quot;names&quot;: Only tool names and server - &quot;descriptions&quot;: Names, server, and descriptions - &quot;full&quot;: Complete tool information including schemas List of tool information dictionaries.</ResponseField>
