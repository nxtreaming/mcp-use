...
><ParamField body="inspector_path" type="str" default='/inspector' >   Path for inspector UI (default: "/inspector") </ParamField>
...
><ParamField body="host" type="str" default='0.0.0.0' >   Default host for server binding. Also controls DNS rebinding protection: </ParamField>
...
**Signature**
```python wrap
def __init__(name: str | None = None, version: str | None = None, instructions: str | None = None, auth: BearerAuthProvider | None = None, middleware: list[Middleware] | None = None, debug: bool = False, mcp_path: str = "/mcp", docs_path: str = "/docs", inspector_path: str = "/inspector", openmcp_path: str = "/openmcp.json", show_inspector_logs: bool = False, pretty_print_jsonrpc: bool = False, host: str = "0.0.0.0", port: int = 8000):
```
