...
icon: "sparkles"
og:image: "https://cdn.mcp-use.com/docs/python/releases/release1.4.1.jpg"
---

<Card img="https://cdn.mcp-use.com/docs/python/releases/release1.4.1.jpg" title="Release 1.4.1" href="https://github.com/mcp-use/mcp-use/releases/tag/python-v1.4.1">
