...
icon: "leaf"
og:image: "https://cdn.mcp-use.com/docs/python/releases/release1.5.2.jpg"
---

import { Contributors } from '/snippets/contributors.jsx'

<Card img="https://cdn.mcp-use.com/docs/python/releases/release1.5.2.jpg" title="Release 1.5.2" href="https://github.com/mcp-use/mcp-use/releases/tag/python-v1.5.2">
