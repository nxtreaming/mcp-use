...
icon: "layers"
og:image: "https://cdn.mcp-use.com/docs/python/releases/release1.3.12.png"
---

import { Contributors } from '/snippets/contributors.jsx'

<Card img="https://cdn.mcp-use.com/docs/python/releases/release1.3.12.png" title="Release 1.3.12" href="https://github.com/mcp-use/mcp-use/releases/tag/1.3.12">
...
For a detailed technical deep-dive into the middleware architecture and design decisions, see our [Middleware Pipeline blog post](/python/blog/middleware).
