...
icon: "sparkles"
og:image: "https://cdn.mcp-use.com/docs/python/releases/release1.5.0.jpg"
---

import { Contributors } from '/snippets/contributors.jsx'

<Card img="https://cdn.mcp-use.com/docs/python/releases/release1.5.0.jpg" title="Release 1.5.0" href="https://github.com/mcp-use/mcp-use/releases/tag/python-v1.5.0">
