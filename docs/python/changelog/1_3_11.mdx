...
icon: "key"
og:image: "https://cdn.mcp-use.com/docs/python/releases/release1.3.11.png"
---

<Card img="https://cdn.mcp-use.com/docs/python/releases/release1.3.11.png" title="Release 1.3.11" href="https://github.com/mcp-use/mcp-use/releases/tag/1.3.11">
