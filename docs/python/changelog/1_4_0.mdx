...
icon: "sparkles"
og:image: "https://cdn.mcp-use.com/docs/python/releases/release1.4.0.png"
---

<Card img="https://cdn.mcp-use.com/docs/python/releases/release1.4.0.png" title="Release 1.4.0" href="https://github.com/mcp-use/mcp-use/releases/tag/python-v1.4.0">
