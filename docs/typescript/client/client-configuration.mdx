...
<Info>
This guide covers MCPClient configuration options for connecting to MCP servers. For agent configuration, see the [Agent Configuration](/typescript/agent/agent-configuration) guide.
</Info>
...
For detailed troubleshooting, see the [Connection Errors](/python/troubleshooting/connection-errors) guide.
