...
<Tip>
**Using in browser or React?** This guide uses the Node.js import (`mcp-use`). For browser or React environments, see the [Environments](/typescript/client/environments) guide to learn about the different entry points.
</Tip>
