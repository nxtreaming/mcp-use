...
<Tip>
For more configuration options and examples, see the [Client Configuration](/typescript/client/client-configuration) documentation.
</Tip>
...
<Tip>
For complete CLI documentation, examples, and advanced usage, see the [CLI Client Guide](/typescript/client/cli).
</Tip>
