...
- Pre-configured server metadata (title, icons, websiteUrl) with your project name and mcp-use branding.
...
├── index.ts           # MCP server entry point with serverInfo configured
├── package.json
├── tsconfig.json
└── README.md
```
