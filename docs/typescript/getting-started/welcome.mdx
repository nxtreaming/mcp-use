...
**mcp-use** is a full-stack MCP framework for TypeScript that provides everything you need to build MCP servers, clients, and agents.

![mcp-use](/images/ts-welcome.png)
...
If you are looking for the **Python** docs, they are [here](/python/getting-started/quickstart).
</Callout>
...
Built-in MCP Inspector for debugging, hot reload for development, and comprehensive documentation.
...
<CardGroup cols={3}>
  ...
  <Card title="MCP Client" icon="router" href="/typescript/client">
    Connect to any MCP server programmatically
  </Card>
  <Card title="MCP Agent" icon="brain" href="/typescript/agent">
